...
<body>
    <div class="container">
        <nav class="navigation">
            <div class="nav-links">
                ...
                <a href="persons_register.html" class="nav-link active">
                    <span class="nav-icon">👥</span>
        ...
        <div class="controls">
            <input type="text" class="search-box" placeholder="Person suchen..." id="searchBox"/>
        ...
        <div class="stats">
            <div class="stat-item">
                <div class="stat-number" id="totalPersons"><xsl:value-of select="count(//tei:person)"/></div>
            ...
            <div class="stat-item">
                <div class="stat-number" id="visiblePersons"><xsl:value-of select="count(//tei:person)"/></div>
                <div class="stat-label">Sichtbare Personen</div>
            </div>
        </div>

        <div class="person-grid" id="personGrid">
            <xsl:for-each select="//tei:person">
                <xsl:sort select="tei:persName[@type='main']" order="ascending"/>
                <div class="person-card"
                     data-name="{translate(tei:persName[@type='main'], 'ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜ', 'abcdefghijklmnopqrstuvwxyzäöü')}"
                    ...
                    <xsl:if test="tei:persName[@type='variation']">
                        <div class="variations">
                            <div class="variations-label">Varianten:</div>
                            <div class="variations-list">
                                <xsl:for-each select="tei:persName[@type='variation']">
        ...
        <div class="no-results hidden" id="noResults">
            Keine Personen gefunden, die den Suchkriterien entsprechen.
        </div>
    </div>
    ...
    <script>
        ...
        const visiblePersonsCount = document.getElementById('visiblePersons');
        ...
        function updateVisibleCount() {
            ...
            visiblePersonsCount.textContent = visibleCards.length;
